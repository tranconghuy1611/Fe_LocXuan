...
import { Sparkles, Mail, Lock, Eye, EyeOff, User, Phone, ArrowRight } from 'lucide-react';
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white border-opacity-30">
              ...
              <div className="space-y-3 text-lg">
                <p className="flex items-center gap-2">
                  ...
                  <span className='text-yellow-300'>Vạn sự như ý</span>
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-2xl">💰</span>
                  <span className='text-yellow-300'>Tài lộc đầy nhà</span>
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-2xl">🏆</span>
                  <span className='text-yellow-300'>Thành công rực rỡ</span>
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-2xl">❤️</span>
                  <span className='text-yellow-300'>An khang thịnh vượng</span>
                </p>
                <p className="flex items-center gap-2">
                  <span className="text-2xl">🌟</span>
            ...
            {isLogin ? (
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2 pt-2">
                  <input type="checkbox" className="mt-0.5 w-3 h-3 text-red-600 rounded" />
